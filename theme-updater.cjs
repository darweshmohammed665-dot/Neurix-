...
const replacements = [
  ...
  { regex: /#040c1c/gi, replacement: '#0B0F19' },
  ...
  { regex: /#FFF8DC/gi, replacement: '#e0f2fe' }, 
  ...
  { regex: /text-gray-400/g, replacement: 'text-[#9CA3AF]' },
  ...
  { regex: /#FFF(?!A)/gi, replacement: '#F9FAFB' },
  { regex: /#FFFFFF/gi, replacement: '#F9FAFB' },
];
