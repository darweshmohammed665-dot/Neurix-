...
export const TelemetryChannelGrid: React.FC = () => {
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 border-b border-[#FBBF24]/15 bg-[#1E293B]/40 font-mono relative">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          className="flex items-center justify-between mb-10 pb-4 border-b border-[#FBBF24]/15"
        >
          <div className="flex items-center gap-3">
            <Radio className="w-5 h-5 text-[#FBBF24] animate-pulse" />
            <div>
          ...
          <div className="hidden sm:flex items-center gap-2 px-3 py-1 bg-[#0F172A] border border-emerald-500/30 text-emerald-400 text-xs">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {systemDiagnostics.map((ch, idx) => (
            <motion.div
              ...
              className="p-5 bg-[#0F172A] border border-[#FBBF24]/20 hover:border-[#FBBF24] hover:shadow-[0_0_20px_rgba(217,119,6,0.2)] transition-all group shadow-sm"
            >
              <div className="flex items-center justify-between pb-2 mb-3 border-b border-[#FBBF24]/10">
                <span className="text-xs font-bold text-[#F9FAFB] group-hover:text-[#FBBF24] transition-colors">
                  {ch.channel}
                </span>
                <span className="text-[10px] px-2 py-0.5 bg-[#1E293B] text-emerald-400 font-bold">
                  {ch.status}
                </span>
              </div>

              <div className="grid grid-cols-3 gap-2 text-center text-xs">
                <div className="p-2 bg-[#1E293B]/50 border border-[#FBBF24]/10">
                ...
                <div className="p-2 bg-[#1E293B]/50 border border-[#FBBF24]/10">
                  ...
                  <p className="font-bold text-[#FBBF24] mt-0.5">{ch.voltage}</p>
                </div>
                <div className="p-2 bg-[#1E293B]/50 border border-[#FBBF24]/10">
